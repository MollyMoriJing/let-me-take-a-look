...
export class AnalysisEngine {
    constructor(config = {}) {
      this.config = {
        ...
        timeouts: {
          normal: 120000,     // 30 seconds for normal requests
          realtime: 120000,   // 15 seconds for real-time requests  
          warmup: 120000     // 2 minutes for first request
        },
        ...config
      }
    ...
    setupEventListeners() {
      ...
      // Listen for quick analysis requests with specific prompts
    ...
    /**
     * Quick analysis methods for specific accessibility needs
     */
    ...
    /**
     * Get accessibility prompt by type
     */
    ...
    /**
     * Set prompt by accessibility type
     */
